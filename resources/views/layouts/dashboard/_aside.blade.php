    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            @if(auth()->user()->hasPermission('read_categories'))
                <li><a href="{{ route('dashboard.categories.index') }}"><i class="fa fa-categories"></i><span>@lang('site.categories')</span></a></li>
            @endif
            ...
            @if(auth()->user()->hasPermission('read_clients'))
                <li><a href="{{ route('dashboard.clients.index') }}"><i class="fa fa-categories"></i><span>@lang('site.clients')</span></a></li>
            @endif

            @if(auth()->user()->hasPermission('read_orders'))
                <li><a href="{{ route('dashboard.orders.index') }}"><i class="fa fa-categories"></i><span>@lang('site.orders')</span></a></li>
            @endif

            @if(auth()->user()->hasPermission('read_users'))
                <li><a href="{{ route('dashboard.users.index') }}"><i class="fa fa-categories"></i><span>@lang('site.users')</span></a></li>
            @endif
